...
function tfuse_prettyPhoto($atts, $content = null)
{
    ...
    if ( $type == 'button' )
        return '<a href="' . $link . '" class="btn ' . $class . '" ' . $style . ' data-rel="prettyPhoto" title="' . $title . '"><span><i class="tficon-zoom-in"></i> ' . $content . '</span></a>';
    else if ( $type == 'image' )
        return '<a href="' . $link . '" class=" prettyPhoto ' . $class . '" ' . $style . ' data-rel="prettyPhoto[' . $gallery . ']" title="' . $title . '" > <img src="'.$thumb.'" alt="" class="frame_box"></a>&nbsp;';
    else if ( $type == 'youtube' )
        return '<a href="' . $link . '" class=" prettyPhoto ' . $class . '" ' . $style . ' data-rel="prettyPhoto[' . $gallery . ']" title="' . $title . '" > <img src="'.$template_directory.'/images/youtube_logo.png" width="48"> </a>&nbsp;';
    else if ( $type == 'vimeo' )
        return '<a href="' . $link . '" class=" prettyPhoto ' . $class . '" ' . $style . ' data-rel="prettyPhoto[' . $gallery . ']" title="' . $title . '" > <img src="'.$template_directory.'/images/vimeo_logo.png" width="48"> </a>&nbsp;';
    else if ( $type == 'site' )
        return '<a href="' . $link . '" class="btn ' . $class . '" ' . $style . ' data-rel="prettyPhoto" title="' . $title . '"><span>' . $content . ' <i class="tficon-external-link"></i></span></a>';
    else
        return '<a href="' . $link . '" class="' . $class . ' prettyPhoto" ' . $style . ' data-rel="prettyPhoto" title="' . $title . '" >' . $content . '</a>';
}
...
$atts = array(
    ...
    'options' => array(
        ...
        array(
            ...
            'desc' => __('Specifies the URL of the thumbnail image','tfuse'),
        ...
        array(
            ...
            'desc' => __('Specify the name, if you want display images in gallery prettyPhoto. EX: pretty_gallery','tfuse'),
