...
class TF_Widget_Instagram extends WP_Widget {
    ...
    function TF_Widget_Instagram() {
        ...
        $this->__construct('Instagram', __('TFuse - Instagram','tfuse'), $widget_ops, $control_ops);
    }
            ...
            <div class="instagram">
                <ul>
                    <?php foreach($instagram_photos as $image){ ?>
                        <li>
                            <a href="http://instagram.com/p/<?php echo $image['code']; ?>">
                ...
                <?php if($follow_button != ''){ ?>
                    <a href="http://instagram.com/<?php echo $user; ?>" class="btn btn-black btn-instagram"><span><?php echo tfuse_qtranslate($follow_button); ?></span></a>
                <?php } ?>
            </div>
        <?php } ?>
    <?php
