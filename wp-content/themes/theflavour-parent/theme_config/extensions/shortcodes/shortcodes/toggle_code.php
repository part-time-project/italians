...
{
    extract(shortcode_atts(array('title' => '', 'class' => 'panel-deafult','box'=>'','type'=>''), $atts));
    $uniq = rand(1,200);
    if($box == 'opened') {
        $b = 'opened';
        $content_class = 'in';
    ...
    if($type == 'default')
    {
        return '<div class="panel '.$class.' toggleitem boxed '.$b.'">
            <div class="panel-heading"><h4 class="panel-title"><a class="panel-toggle" data-toggle="collapse" href="#toggleOne'.$uniq.'">' . $title . '<span class="icon icon-toggle"></span></a></h4></div>
            <div id="toggleOne'.$uniq.'" class="panel-collapse collapse '.$content_class.'">
    ...
    else
    {
        return '<div class="'.$class.' toggleitem '.$b.'">
            ...
            <div id="toggleThree'.$uniq.'" class="panel-collapse collapse '.$content_class.'">' . do_shortcode($content) . ' </div>
        </div>';
    }
}
