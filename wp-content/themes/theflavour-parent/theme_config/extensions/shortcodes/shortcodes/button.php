...
$atts = array(
    ...
    'options' => array(
        array(
            'name' => __('Class','tfuse'),
            'desc' => __('Specifies one or more class names for an shortcode, separated by space.<br /><b>predefined classes:</b> btn-transparent, btn-black, btn-black-transparent, btn-orange, btn-orange-transparent','tfuse'),
