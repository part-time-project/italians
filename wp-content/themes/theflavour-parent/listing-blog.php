        ...
        <div class="entry-aside">
            <header class="entry-header">
                <div class="entry-meta">
                    ...
                    <h1 class="entry-title"><a href="<?php echo $permalink; ?>"><?php the_title(); ?></a></h1>
                </div>
                <?php
            ...
            <footer class="entry-meta">
                <a href="<?php echo $permalink; ?>" class="btn btn-black-transparent btn-xs"><span><?php _e('find out more','tfuse'); ?></span></a>
